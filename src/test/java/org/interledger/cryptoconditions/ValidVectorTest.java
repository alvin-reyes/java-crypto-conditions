 ...
 * <p/>
 * Specifically, this harness performs the following validations according to the source of the test
 * 'vectors' file in the crypto-conditions rfc project:
 *
 * <pre>
 * <ul>
    ...
    switch (actualTestCondition.getType()) {
      ...
      case PREFIX_SHA256: {
        unhashedFingerprintContents =
            ((PrefixSha256Condition.Impl) actualTestCondition).constructFingerprintContents(
